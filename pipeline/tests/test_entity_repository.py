...
@pytest.fixture
async def test_extraction(db_session, test_project, test_source):
...
class TestEntityRepositoryCreate:
    ...
    async def test_create_entity_with_minimal_data(
    ...
    async def test_create_entity_returns_persisted_object(
        self, entity_repo, test_project, db_session
    ):
...
class TestEntityRepositoryGet:
    ...
    async def test_get_nonexistent_returns_none(self, entity_repo):
        """Should return None for nonexistent entity."""
        from uuid import uuid4

        retrieved = await entity_repo.get(uuid4())
...
class TestEntityRepositoryGetOrCreate:
    ...
    async def test_get_or_create_returns_existing_entity(
        ...
        entity2, created2 = await entity_repo.get_or_create(
            project_id=test_project.id,
            source_group="test_company",
            entity_type="company",
    ...
    async def test_get_or_create_deduplicates_case_variations(
        self, entity_repo, test_project
    ):
    ...
    async def test_get_or_create_scoped_by_project(
        self, entity_repo, test_project, db_session
    ):
    ...
    async def test_get_or_create_scoped_by_source_group(
        self, entity_repo, test_project
    ):
...
class TestEntityRepositoryListByType:
    ...
    async def test_list_by_type_filters_by_source_group(
        self, entity_repo, test_project
    ):
    ...
    async def test_list_by_type_returns_empty_for_no_match(
        self, entity_repo, test_project
    ):
...
class TestEntityRepositoryList:
    ...
    async def test_list_all_entities(self, entity_repo, test_project):
...
class TestEntityRepositoryLinkToExtraction:
    ...
    async def test_link_to_extraction_creates_link(
    ...
    async def test_link_to_extraction_with_custom_role(
        self, entity_repo, test_project, test_extraction
    ):
...
class TestEntityRepositoryGetEntitiesForExtraction:
    ...
    async def test_get_entities_for_extraction_returns_entities(
        self, entity_repo, test_project, test_extraction
    ):
    ...
    async def test_get_entities_for_extraction_returns_empty_for_none(
...
class TestEntityRepositoryGetExtractionsForEntity:
    ...
    async def test_get_extractions_for_entity_returns_extractions(
        ...
        extractions = await entity_repo.get_extractions_for_entity(entity.id)
    ...
    async def test_get_extractions_for_entity_returns_empty_for_none(
        self, entity_repo, test_project
    ):
