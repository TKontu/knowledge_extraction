...
class TestListJobs:
    ...
    def test_list_jobs_filter_by_date_range(
        ...
        response = client.get(f"/api/v1/jobs?created_after={yesterday}")
    ...
    def test_list_jobs_pagination(
        ...
        # Second page
        response = client.get("/api/v1/jobs?limit=2&offset=2")
        assert response.status_code == 200
        data = response.json()
...
class TestGetJob:
    ...
    def test_get_job_invalid_uuid(self, client: TestClient) -> None:
