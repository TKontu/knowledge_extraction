...
class TestEntityRepositoryCreate:
    ...
    def test_create_entity_with_attributes(self, entity_repo, test_project):
    ...
    def test_create_entity_sets_created_at(self, entity_repo, test_project):
...
class TestEntityRepositoryGet:
    ...
    def test_get_by_id_returns_entity(self, entity_repo, test_project):
...
class TestEntityRepositoryGetOrCreate:
    ...
    def test_get_or_create_creates_new_entity(self, entity_repo, test_project):
    ...
    def test_get_or_create_returns_existing_entity(self, entity_repo, test_project):
    ...
    def test_get_or_create_scoped_by_source_group(self, entity_repo, test_project):
    ...
    def test_get_or_create_scoped_by_entity_type(self, entity_repo, test_project):
    ...
    def test_get_or_create_with_attributes(self, entity_repo, test_project):
...
class TestEntityRepositoryListByType:
    ...
    def test_list_by_type_returns_entities(self, entity_repo, test_project):
    ...
    def test_list_by_type_filters_by_source_group(self, entity_repo, test_project):
    ...
    def test_list_by_type_returns_empty_for_no_match(self, entity_repo, test_project):
    ...
    def test_list_by_type_sorted_by_value(self, entity_repo, test_project):
...
class TestEntityRepositoryList:
    ...
    def test_list_filters_by_project_id(self, entity_repo, test_project, db_session):
        ...
        entities = entity_repo.list(EntityFilters(project_id=test_project.id))
        assert len(entities) >= 1
        assert all(e.project_id == test_project.id for e in entities)

    def test_list_filters_by_entity_type(self, entity_repo, test_project):
        ...
        entities = entity_repo.list(EntityFilters(entity_type="pricing"))
        assert len(entities) >= 1
        assert all(e.entity_type == "pricing" for e in entities)

    def test_list_filters_by_source_group(self, entity_repo, test_project):
        ...
        entities = entity_repo.list(EntityFilters(source_group="specific_company"))
        assert len(entities) >= 1
...
class TestEntityRepositoryGetEntitiesForExtraction:
    ...
    def test_get_entities_for_extraction_returns_entities(
        ...
        entities = entity_repo.get_entities_for_extraction(test_extraction.id)
