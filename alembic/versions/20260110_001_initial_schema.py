...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("entity_types", postgresql.JSONB(), nullable=False, server_default=sa.text("'[]'")),
        sa.Column("prompt_templates", postgresql.JSONB(), nullable=False, server_default=sa.text("'{}'")),
        sa.Column("is_template", sa.Boolean(), default=False, server_default=sa.text("false")),
    ...
    op.create_table(
        ...
        sa.Column("source_type", sa.Text(), nullable=False, server_default=sa.text("'web'")),
    ...
    op.create_index("idx_extractions_data", "extractions", ["data"], postgresql_using="gin")
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.text("NOW()")),
        sa.ForeignKeyConstraint(["project_id"], ["projects.id"], ondelete="CASCADE"),
        sa.UniqueConstraint("project_id", "source_group", "entity_type", "normalized_value"),
    )
